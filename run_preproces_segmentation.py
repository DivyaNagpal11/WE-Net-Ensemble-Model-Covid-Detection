...
"""
Pass arguments that are needed to process files for segmentation
...
parser.add_argument("-sp", "--source_path", 
                    required=True, 
                    help="Raw Images Path -  mention source dataset path you want to provide")
parser.add_argument("-mp", "--mask_path", required=True,
                    help="Masks Path - mention lung mask path you want to provide")
parser.add_argument("-mmp", "--merged_mask_path", required=True,
                    help="Merged Mask Path - mention merged mask path to save left and right lung masks in single image")
...
parser.add_argument("-ap", "--aug_path", required=True,
                    help="Augmented Data Path - mention augmented data path to save augmented train data set")
